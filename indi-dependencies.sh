...
echo "Installing system dependencies for INDI 3rd party..."
...
sudo apt install libnova-dev libcfitsio-dev libusb-1.0-0-dev zlib1g-dev libgsl-dev build-essential cmake git \
    ...
    pkg-config libev-dev libqt5datavisualization5-dev libzmq3-dev libudev-dev libopencv-dev \
    cdbs dkms fxload libkrb5-dev libtheora-dev libindi-dev
